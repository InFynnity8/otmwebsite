  ...
  return (
    <div className="bg-primary">
      <div className="container m-auto flex flex-col justify-center items-center py-2">
        ...
        <p className="text-[16px] w-full xl:w-[600px] text-center text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 justify-center items-center gap-5">
          <div className="xl:w-[210px] xl:h-[180px] w-full h-[100px] text-center flex flex-col justify-center items-center ">
